...
--ppo_epoch 15 --wandb_name "samji2000" --user_name "gaojiaxuan" --reward_shaping_horizon 100000000 \
--n_rollout_threads 300 --train_env_batch 1 \
--stage 2 --save_interval 20 --log_interval 10 \
--population_yaml_path ${path}/${layout}/mep/s2/config.yml \
--population_size 36 --adaptive_agent_name alice --use_agent_policy_id --overcooked_version ${version}